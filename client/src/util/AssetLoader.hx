...
class AssetLoader {
	...
	public static var OBJECT_FILES = [
		"Projectiles", "Equip", "Players", "EnemiesLowRealm", 
		"EnemiesMidRealm", "Containers", "Portals", "StaticObjects", 
		"Test", "Objects", "Skins"
	];
	...
	public static function load() {
		...
		AnimatedChars.add("playerskins", Assets.getBitmapData("assets/sheets/PlayerSkins.png"), Assets.getBitmapData("assets/sheets/PlayerSkinsMask.png"), 8, 8, 48, 24);
